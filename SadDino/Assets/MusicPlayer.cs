...
public class MusicPlayer : MonoBehaviour
{
    ...
    public AudioClip gameClip;              //Clip to play during lvl1 scenen
    public AudioClip retro;               //Clip to play at the lvl1 scene
    public AudioClip africa;               //Clip to play at the lvl3 scene
